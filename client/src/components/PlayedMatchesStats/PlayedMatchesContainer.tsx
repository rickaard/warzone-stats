    ...
    return (
        <section className="matches-history-wrapper">
            ...
            <div className="played-matches--container">
                ...
                <PlayedMatchesCard playedData={[totalMatches, top25]} label="Top 25" doughnutPieceColor="#077ea3"/>
                <PlayedMatchesCard playedData={[totalMatches, top10]} label="Top 10" doughnutPieceColor="#077ea3"/>
                <PlayedMatchesCard playedData={[totalMatches, top5]} label="Top 5" doughnutPieceColor="#077ea3"/>
                <PlayedMatchesCard playedData={[totalMatches, wins]} label="Wins" doughnutPieceColor="#fdd709"/>
            </div>
        </section>
    );
